          ...
          {products.map((product) => (
            <div key={product.id}>
              ...
              <div className="mt-6">
                <a
                  href={product.href}
                  className="relative flex items-center justify-center rounded-md border border-transparent bg-[#3AA39F] py-2 px-8 text-sm font-medium text-white hover:bg-[#2e918c]"
                >
